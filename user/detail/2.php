           ...
           <!-- kasi div baru buat  elemnt laen -->
            ...
            <div class="flex">
              <span class="title-font font-medium text-2xl text-gray-900"
                >Rp. <?php echo number_format($service[1]['price'], 0, ',', '.'); ?></span
              >
              <button
            ...
            <div class="p-6">
                ...
                <form method="POST" class="space-y-4" action="order.php" name="order">
                    <div class="border-b pb-4 mb-4">
                        ...
                        <p class="text-gray-600 mt-1"><?= $service[1]['name'] ?></p>
                        <p class="text-gray-800 font-medium mt-1">Rp. <?php echo number_format($service[1]['price'], 0, ',', '.'); ?></p>
                    </div>
                    ...
                    <div class="flex justify-between pt-4">
                        ...
                        <input type="hidden" name="order" value="<?= $service[1]['id'] ?>">
                        <button type="submit" 
